...
- [Pagoda: Rapid, easy full-stack web development starter kit in Go](#pagoda-rapid-easy-full-stack-web-development-starter-kit-in-go)
  ...
  - [Introduction](#introduction)
    ...
    - [Screenshots](#screenshots)
      ...
      - [Switch layout templates, user registration](#switch-layout-templates-user-registration)
      - [Alpine.js modal, HTMX AJAX request](#alpinejs-modal-htmx-ajax-request)
  ...
  - [Pages](#pages)
    ...
    - [HTMX support](#htmx-support)
      - [Layout template override](#layout-template-override)
      - [Conditional processing / rendering](#conditional-processing--rendering)
